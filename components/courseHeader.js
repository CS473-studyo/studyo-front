        ...
        <div className="container h-100">
          <div className="row h-100">
            <div className={`col ${styles["course-title"]}`}>
              <a href="/main" className={`title-text ${styles["course-title"]}`}>
                <ArrowBackIcon fontSize="large"></ArrowBackIcon>
                Main
              </a>
            </div>
            <h1 className={`col-6 title-text text-center ${styles["course-title"]}`}>{courseid} {courseName}</h1>
            <div className="col">
              <div className={`body-text text-right ${styles["course-detail"]}`}>
